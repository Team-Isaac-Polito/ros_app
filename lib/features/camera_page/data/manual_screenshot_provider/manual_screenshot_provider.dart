...
final manualScreenShotProvider = NotifierProvider<ManualScreenshotNotifier, List<String>>(
  ManualScreenshotNotifier.new,
);

class ManualScreenshotNotifier extends Notifier<List<String>> {
